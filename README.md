...
Поддерживает интерактивный запуск shell-команд через единственный инструмент (`run_shell_command`) с ручным подтверждением или белым списком разрешённых команд.
